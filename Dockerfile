...
&& openssl req -x509 -nodes -days 3650 -newkey rsa:2048 -subj "/C=US/ST=Denial/L=Springfield/O=Dis/CN=zenoss5.local" -keyout /etc/pki/tls/private/localhost.key -out /etc/pki/tls/certs/localhost.crt
